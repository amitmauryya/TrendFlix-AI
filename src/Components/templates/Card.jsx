...
const Card = ({data ,title}) => {
  return (
    <div className='flex flex-wrap w-full justify-center  bg-[#1F1E24] '>
          {data.map((c, i) => <Link className=' relative w-[25vh] mr-[5%] mb-[3%]' key={i}>
              <img  className=' hover:scale-102 rounded  h-[40vh] shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] object-cover' src={`https://image.tmdb.org/t/p/original/${
